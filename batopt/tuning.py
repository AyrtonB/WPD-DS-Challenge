...
__all__ = ['calculate_pct_peak_reduction_s', 'calculate_emissions_factor_s', 'calculate_score_s', 'feature_selection',
           'score_charge', 'score_discharge', 'max_charge_score', 'calculate_score_s', 'evaluate_submission']
...
def evaluate_submission(submission_fn, raw_data_dir, intermediate_data_dir):
    ...
    solution_discharge = solution.between_time('15:30', '20:30')

    real_charge = real.between_time('00:00', '15:00')
    real_discharge = real.between_time('15:30', '20:30')
    ...
    df = pd.DataFrame({'total_score': total_score,
              ...
              'max_charge_score': max_charge_score(real_charge.pv_power_mw)})
